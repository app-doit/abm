...
<p>&nbsp;</p>
    <p align="center">
    <h1 class="style4">MASUKKAN NOMOR HP </h1>
    </p>
    <p align="center" class="style4">TEKAN CANCEL UNTUK MEMBATALKAN TRANSAKSI</p>
    <p align="center" class="style4"><input type="text" class="inputhp"></p>
    <p align="right" class="style3">&nbsp;</p>
    <p align="right" class="style3"><a href="<?php echo base_url();?>dana_isi" class="style5">LANJUT</a> </p>
    <p>
      <script>
