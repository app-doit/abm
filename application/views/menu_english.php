...
<body>
    <div>
        ...
        <table width="100%" border="0" cellpadding="20" cellspacing="1">
          <tr>
            <td height="81"><div align="right" class="style2">
              <div align="left">TRANSFER </div>
            </div></td>
            <td>&nbsp;</td>
            <td><div align="right" class="style2"><a href="<?php echo base_url();?>tariktunai_english">WITHDRAW </a> </div></td>
          </tr>
          <tr>
            <td height="81"><div align="right" class="style2">
              <div align="left">TOPUP </div>
            </div></td>
            <td>&nbsp;</td>
            <td><div align="right" class="style2">BALANCE CHECKING </div></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
