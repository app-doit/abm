...
<html lang="en">
  ...
  <body>
    <p>&nbsp;</p>
    <p align="center" class="style3">TRANSFER</p>
    <p align="center" class="style3">TEKAN CANCEL UNTUK MEMBATALKAN TRANSAKSI</p>
    <p align="center" class="style3">&nbsp;</p>
    <div class="flex-nominal">
      <div class="flex-col">
        <p class="style3">MONEY TRANSFER</p>
        <p class="style3">REKENING GROUP</p>
      </div>
      <div class="flex-col">
        <p class="style3">KE REKENING BANK</p>
        <p class="style3">ANTAR BANK ONLINE</p>
        <p class="style3">TRANSFER KE TOKO ONLINE</p>
      </div>
    </div>
    <p>
      <script></script>
