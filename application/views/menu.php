...
<body>
    <div>
        <h2 align="center" class="style2">MENU</h2>
        <h2>
        ...
        <table width="100%" border="0" cellpadding="20" cellspacing="1">
          <tr>
            <td width="39%" height="328"><div align="left"  class="style2"><a href="<?php echo base_url();?>transfer">TRANSFER</a></div></td>
            <td width="13%">&nbsp;</td>
            <td width="48%"><div align="right" class="style2"><a href="<?php echo base_url();?>tariktunai">TARIK TUNAI </a> </div></td>
          </tr>
          <tr>
            <td height="81">TOPUP</td>
            <td>&nbsp;</td>
            <td><div align="right" class="style2"><a href="<?php echo base_url();?>ceksaldo">CEK SALDO</a> </div></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
