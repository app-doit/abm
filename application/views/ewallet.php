...
<html lang="en">
  ...
  <body>
    <p align="center">PILIH </p>
    <p align="center" class="style4">&nbsp;</p>
    <div class="flex-nominal">
      <div class="flex-col">
      <a href="<?php echo base_url();?>dana">Dana</a><br>
      &nbsp;<br>
      <a href="<?php echo base_url();?>gopay">Gopay</a><br>
&nbsp;      <br>
&nbsp;      <br>
      </div>
      <div class="flex-col ratakanan">
        <a href="<?php echo base_url();?>ovo">OVO</a><br>
        &nbsp;<br>
        <a href="<?php echo base_url();?>linkaja">Link Aja </a><br>
        &nbsp;<br>
        &nbsp;&nbsp;<br>
      </div>
    </div>
