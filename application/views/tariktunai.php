...
<body>
    <div>
        <h1>&nbsp;</h1>
        <h1 align="center">TARIK TUNAI </h1>
        <h2>
        ...
        <table width="100%" border="0" cellpadding="20" cellspacing="1">
          <tr>
            <td height="81">&nbsp;</td>
            <td>&nbsp;</td>
            <td><div align="right"><span class="style2"><a href="<?php echo base_url();?>ewallet">E-WALLLET</a></span></div></td>
          </tr>
          <tr>
            <td height="81">&nbsp;</td>
            <td>&nbsp;</td>
            <td><div align="right" class="style2"><a href="<?php echo base_url();?>password">TABUNGAN</a></div></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><div align="right" class="style2"><a href="<?php echo base_url();?>tarik_tunai_langsung">TARIK TUNAI</a></div></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
